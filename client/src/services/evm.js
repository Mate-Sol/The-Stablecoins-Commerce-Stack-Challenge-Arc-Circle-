...
/** Token strategy identical to services/solana.js — lender token in
 *  localStorage, PSP/admin in sessionStorage; lender wins on /lender paths. */
function getToken() {
  ...
  const onLenderPath =
    ...
    (window.location.pathname.startsWith('/lender') ||
     window.location.pathname.startsWith('/lender-v2'));
